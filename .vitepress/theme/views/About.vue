<template>
  <div class="about">
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item hello">
        ...
        <span class="text2 title2">我是 Quisper</span>
        <span class="text3">是一名 喜欢搞点稀奇古怪的学习者</span>
      </div>
      <!-- 追求 -->
    ...
    <!-- <div class="about-item career">
        ...
        <div class="list">
          <span class="list-item" style="--color: #357ef5">计算机应用技术</span>
  ...
  <!-- <div class="about-content" style="grid-template-columns: 1fr 1fr">
    <div class="about-item like image" style="
          --color: #0c0e20;
