  ...
  <footer id="main-footer" class="main-footer">
    <div class="footer-content">
      <div class="copyright">
        ...
        <a class="ga link" :href="`https://beian.mps.gov.cn/#/query/webSearch?code=${theme.gacode}`" rel="noreferrer" target="_blank">
          <img src="/images/备案图标.png" alt="公安备案图标" class="ga-icon" />
          {{ theme.ga }}
        </a>
        <a class="EdgeOne link" href="https://cloud.tencent.com/product/teo" target="_blank">
      ...
      <div class="meta">
        ...
        <a class="theme link" href="https://github.com/imsyy/vitepress-theme-curve" target="_blank">
          <span class="by">Modified from </span>
          <span class="name">Curve</span>
        </a>
        <a class="rss link" href="https://blog.civer.cn/rss.xml" target="_blank">
