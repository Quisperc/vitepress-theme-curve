...
1. Application Name：建议使用`mongo`，方便vanblog环境变量`Environment Variables`配置。
   ...
   ![image-20250510225902816](https://buc.civer.cn/picgo/image-20250510225902816.png)

2. Image：选择public，下面填写镜像地址`mongo`

   ![image-20250510225837710](https://buc.civer.cn/picgo/image-20250510225837710.png)

3. Usage：使用fixed，自行调整，replicas默认为1，CPU选择0.1，Memory选择128M

   ![image-20250510225934001](https://buc.civer.cn/picgo/image-20250510225934001.png)

4. NetWork：端口选择`27017`，不开启Enable Internet Access。

   ![image-20250510230936173](https://buc.civer.cn/picgo/image-20250510230936173.png)
...
6. Local Storage：配置`/data`即可
   ...
   ![image-20250510231015116](https://buc.civer.cn/picgo/image-20250510231015116.png)
...
2. Image：选择public，下面填写镜像地址`mereith/van-blog:latest`
   ...
   ![image-20250510224626144](https://buc.civer.cn/picgo/image-20250510224626144.png)

3. Usage：使用fixed，自行调整，replicas默认为1，CPU选择0.2，Memory选择512M

   ![image-20250510224649788](https://buc.civer.cn/picgo/image-20250510224649788.png)

4. NetWork：端口选择默认80，开启Enable Internet Access。地址可以默认也可以自定义。选择自定义则需要自行配置域名。

   ![image-20250510224727520](https://buc.civer.cn/picgo/image-20250510224727520.png)
...
5. Environment Variables：
   ...
   ![image-20250510225006075](https://buc.civer.cn/picgo/image-20250510225006075.png)

   ![image-20250510225109402](https://buc.civer.cn/picgo/image-20250510225109402.png)

6. Local Storage：配置`/data`即可

   ![image-20250510225155412](https://buc.civer.cn/picgo/image-20250510225155412.png)

![image-20250510225258532](https://buc.civer.cn/picgo/image-20250510225258532.png)
...
![image-20250510231751325](https://buc.civer.cn/picgo/image-20250510231751325.png)
...
![image-20250510231847211](https://buc.civer.cn/picgo/image-20250510231847211.png)
